...
#Setts default Environment
from database_connector_kit.config import Environment
try:
    #Load Environment from fastapi_framework_mvc < 1.3.0 if installed
...
class Driver(object):
    ...
    Requires Environment to be loaded first.
    ...
    def setup_sessions(cls, app):
        ...
        if isinstance(app, Flask):
            ...
            logging.warning(f"setup_sessions not implemented for {type(app)}")
        return app
